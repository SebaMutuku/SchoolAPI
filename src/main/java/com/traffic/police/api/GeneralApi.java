...
import com.traffic.police.services.OffenceService;
...
public class GeneralApi {
    ...
    @RequestMapping(value = "/offences/getAllByOfficerName", method = RequestMethod.POST, consumes = {"application/json",
            "application/xml"}, produces = {"application/json", "application/xml"})
    ...
    @RequestMapping(value = "/crimedesc/getAllcrimes", method = RequestMethod.POST, consumes = {"application/json",
            "application/xml"}, produces = {"application/json", "application/xml"})

    public ResponseEntity getAllCrimes(@RequestBody GeneralRequest<OffencesEntity> generalRequest, HttpServletRequest request, HttpServletResponse response) {
        return new ResponseEntity(crimeService.fethAllCrimes(generalRequest), HttpStatus.OK);
    }

    @RequestMapping(value = "/offences/getspecificOffence", method = RequestMethod.POST, consumes = {"application/json",
            "application/xml"}, produces = {"application/json", "application/xml"})

    public ResponseEntity getSpecifiOffence(@RequestBody GeneralRequest<OffencesEntity> generalRequest, HttpServletRequest request, HttpServletResponse response) {
        return new ResponseEntity(offenceService.getOffenceAmount(generalRequest), HttpStatus.OK);
    }


    @RequestMapping(value = {"/offences/crimedesc"}, method = {RequestMethod.POST}, consumes = {"application/json", "application/xml"}, produces = {"application/json", "application/xml"})
    public ResponseEntity crimeDesc(@RequestBody GeneralRequest<OffencesEntity> generalRequest, HttpServletRequest request, HttpServletResponse response) {
        return new ResponseEntity(this.crimeService.createCrimeDesc(generalRequest), HttpStatus.OK);
    }

    @RequestMapping(value = {"/offences/updateCrime"}, method = {RequestMethod.POST}, consumes = {"application/json", "application/xml"}, produces = {"application/json", "application/xml"})
    public ResponseEntity updateCrime(@RequestBody GeneralRequest<OffencesEntity> generalRequest, HttpServletRequest request, HttpServletResponse response) {
        return new ResponseEntity(this.crimeService.updateCrime(generalRequest), HttpStatus.OK);
    }
